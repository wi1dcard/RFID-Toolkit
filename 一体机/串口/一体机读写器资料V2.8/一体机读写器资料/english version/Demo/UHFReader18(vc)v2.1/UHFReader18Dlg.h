// UHFReader18Dlg.h : header file
//

#if !defined(AFX_UHFReader18DLG_H__3A770EAB_F39A_4545_B43E_703F7CE3A186__INCLUDED_)
#define AFX_UHFReader18DLG_H__3A770EAB_F39A_4545_B43E_703F7CE3A186__INCLUDED_
...
class CUHFReader18Dlg : public CDialog
{
// Construction
public:
	CUHFReader18Dlg(CWnd* pParent = NULL);	// standard constructor
	...
	typedef int (FAR WINAPI*PSetWorkMode)(unsigned char *ComAdr, 
		                                  unsigned char *Parameter, 
										  int FrmHandle);
		
	typedef int (FAR WINAPI*PGetWorkModeParameter)(unsigned char *ComAdr, 
												   unsigned char *Parameter, 
												   int FrmHandle);
	...
	typedef int (FAR WINAPI*PReadActiveModeData)(unsigned char *ScanModeData,
				                                 int *Datalength,
                                                int FrmHandle);
	...
	PSetWorkMode        RR_SetWorkMode;
	PGetWorkModeParameter      RR_GetWorkModeParameter;
	PReadCard_G2        RR_ReadCard_G2;
	PWriteCard_G2       RR_WriteCard_G2;
	PReadActiveModeData   RR_ReadActiveModeData;
// Dialog Data
	//{{AFX_DATA(CUHFReader18Dlg)
	enum { IDD = IDD_UHFReader18_DIALOG };
	CButton	m_bt11;
	CButton	m_bt10;
	CButton	m_bt8;
	CButton	m_bt7;
...
#endif // !defined(AFX_UHFReader18DLG_H__3A770EAB_F39A_4545_B43E_703F7CE3A186__INCLUDED_)
